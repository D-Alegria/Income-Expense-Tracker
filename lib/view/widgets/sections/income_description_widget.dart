...
import 'package:budget_app/view/forms/delete_income_form.dart';
...
class IncomeDescriptionWidget extends StatefulWidget {
  @override
  _IncomeDescriptionWidgetState createState() => _IncomeDescriptionWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    void _showDeleteModal(Income income) {
      showModalBottomSheet(
          ...
          context: context,
          builder: (context) {
            return DeleteIncomeForm(income: income,loader: toggleLoader);
          });
    }
